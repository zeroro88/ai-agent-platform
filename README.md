...
- 调试页（经 Gateway 外层调用）：[http://localhost:8081/app/](http://localhost:8081/app/)
- LangGraph Studio（意图路由图调试）：[http://localhost:8081/?instance=intent-routing](http://localhost:8081/?instance=intent-routing)
